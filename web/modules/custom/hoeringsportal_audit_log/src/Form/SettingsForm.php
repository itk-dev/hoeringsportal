...
final class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    ...
    // EntityType (implements EntityTypeInterface) contains meta data for entity types, e.g. node, taxonomy term.
    // Below getDefinitions, return the current definitions in the Drupal installation, and their meta data.
