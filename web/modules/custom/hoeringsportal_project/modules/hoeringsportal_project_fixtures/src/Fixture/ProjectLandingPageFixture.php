 ...
 */
class ProjectLandingPageFixture extends AbstractFixture implements DependentFixtureInterface, FixtureGroupInterface {
  ...
  public function load() {
    $entity = Node::create([
      ...
      'field_teaser' => [
        'value' => <<<'BODY'
<p>Samler information om projekter i kommunen.</p>
BODY
      ],
    ...
    $paragraph = Paragraph::create([
      'type' => 'content_list',
      'field_content_list' => [
        'target_id' => 'all_projects',
        'display_id' => 'default',
        'data' => '',
      ],
      'field_list_title' => 'All projects',
    ]);
    $paragraph->save();
    ...
    $entity->save();
    $this->addReference('node:landing_page:Projects', $entity);
  }
